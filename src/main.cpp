...
uint256 hashGenesisBlock("0x41c28deb7d6d5d428bb7af62fafab878e535fdd7ded77a2bb7a405904f3130c7");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "exc genesis block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	    ...
	    assert(block.hashMerkleRoot == uint256("0xb956e3de9a685173528815d2774e160c5453943f220b89a33458820db161d8ad"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd4, 0xcf, 0xae, 0x1b };
